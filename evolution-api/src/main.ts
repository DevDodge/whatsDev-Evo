...
import { localRouter } from '@api/integrations/storage/local/routes/local.router';
...
async function bootstrap() {
  ...
  // Local storage media serving
  if (configService.get('LOCAL_STORAGE')?.ENABLED) {
    app.use(localRouter(configService));
    logger.log('Local storage enabled');
  }
