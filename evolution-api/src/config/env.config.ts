  ...
  private envProcess(): Env {
    return {
      ...
      LOCAL_STORAGE: {
        ...
        BASE_URL: process.env?.LOCAL_STORAGE_BASE_URL || 'http://localhost:8080',
        PATH: process.env?.LOCAL_STORAGE_PATH || './uploads/media',
        ORGANIZE_BY_DATE: process.env?.LOCAL_STORAGE_ORGANIZE_BY_DATE === 'true',
      },
      AUTHENTICATION: {
        API_KEY: {
