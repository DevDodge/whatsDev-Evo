    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="flex items-center justify-between px-4 py-2">
        <div className="flex items-center">
          <img
            src={theme === "dark" ? "/assets/images/white logo.png" : "/assets/images/black logo.png"}
            alt="WhatsDeveloper Logo"
            className="h-8"
          />
        </div>
          ...
          <Card className="mb-8">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Welcome to WhatsDeveloper Manager
              </CardTitle>
              <CardDescription>
                A powerful WhatsApp management platform built on Evolution API by DK-Octobot
              </CardDescription>
            </CardHeader>
